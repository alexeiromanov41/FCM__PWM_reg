...
#define butPrab2_Pin GPIO_PIN_6
#define butPrab2_GPIO_Port GPIOA
#define butPrab1_Pin GPIO_PIN_7
#define butPrab1_GPIO_Port GPIOA
#define rele2_Pin GPIO_PIN_10
...
#define inductionSensor_Pin GPIO_PIN_10
#define inductionSensor_GPIO_Port GPIOA
